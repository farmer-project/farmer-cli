 ...
 */
CreateBackup.prototype.setData = function (data) {
    this.data = data;
 ...
 * @returns {*|promise}
 */
CreateBackup.prototype.executeOn = function (server) {
    var deferred = Q.defer(),
        secureReq = new SecureRequest(),
        opt = {
            uri: url.resolve(server.api, '/api/container/greenhouse/backup/create'),
            method: 'POST',
            json: this.data
        };
