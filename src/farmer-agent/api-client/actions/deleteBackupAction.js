 ...
 */
DeleteBackup.prototype.setData = function (data) {
    this.data = data;
...
/**
 * Send delete backup request
 * @param {Object} server - farmer server specification
 * @returns {*|promise}
 */
DeleteBackup.prototype.executeOn = function (server) {
    var deferred = Q.defer(),
        secureReq = new SecureRequest(),
        opt = {
            uri: url.resolve(server.api, '/api/container/greenhouse/backup/delete'),
            method: 'DELETE',
            json: this.data
        };
...
module.exports = new DeleteBackup();
