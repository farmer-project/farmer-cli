 ...
 * @returns {InspectAction}
 */
InspectAction.prototype.setData = function (data) {
    this.data = data;
 ...
 * @returns {*|promise}
 */
InspectAction.prototype.executeOn = function (server) {
    var deferred = Q.defer(),
        secureReq = new SecureRequest(),
        opt = {
            uri: url.resolve(server.api, '/api/container/greenhouse/inspect'),
            method: 'GET',
            json: this.data
        };
...
module.exports = new InspectAction();
