 ...
 */
UnassignDomainAction.prototype.setData = function (data) {
    this.data = data;
 ...
 * @returns {*|promise}
 */
UnassignDomainAction.prototype.executeOn = function (server) {
...
module.exports = new UnassignDomainAction();
